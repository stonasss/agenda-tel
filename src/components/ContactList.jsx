...
export default function ContactList({ addContactModal, setAddContactModal }) {
                    ...
                    userContacts.map((contact) => (
                        <div key={contact.id} className="relative border-b border-solid pt-4 pb-4">
                            <div className="flex flex-row">
                                ...
                                <h1 className="absolute left-14 top-4 w-32">{contact.name}</h1>
                            </div>
                            ...
                            <span className="flex flex-row">
                                <img src={Edit} alt="editar contato" className="absolute w-4 right-7 bottom-8 hover:cursor-pointer"/>
